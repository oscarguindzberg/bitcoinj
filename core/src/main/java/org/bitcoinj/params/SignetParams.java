...
public class SignetParams extends AbstractBitcoinNetParams {
    ...
    public SignetParams(Script blockStript, byte sigLength, String[] seedNode) {
        super();
        id = ID_SIGNET; //listo
        packetMagic = 0xf0c7706a; //listo
        interval = INTERVAL; //listo
        targetTimespan = TARGET_TIMESPAN; //listo
        maxTarget = Utils.decodeCompactBits(0x1d00ffffL); //listo
        port = 38333; // listo
        addressHeader = 111;
        p2shHeader = 196;
        ...
        subsidyDecreaseBlockCount = 210000; //listo
