...
public class PeerGroupBloomFilterTest extends TestWithPeerGroup {
    ...
    private void testFilterUpdate(Script.ScriptType scriptType) throws Exception {
        ...
        Wallet w = new Wallet(params, KeyChainGroup.builder(params).fromRandom(scriptType).lookaheadSize(100).build());
        ...
        funding.addOutput(Coin.FIFTY_COINS, receiveAddress);
